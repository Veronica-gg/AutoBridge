...
#ifndef _kernel0_PE_0_0_s_HH_
#define _kernel0_PE_0_0_s_HH_
...
struct kernel0_PE_0_0_s : public sc_module {
    ...
    // Module declarations
    kernel0_PE_0_0_s(sc_module_name name);
    SC_HAS_PROCESS(kernel0_PE_0_0_s);
    ...
    sc_signal< sc_lv<1> > icmp_ln899_reg_87;
    sc_signal< sc_logic > fifo_A_in_V_blk_n;
    sc_signal< sc_logic > fifo_U_drain_out_V_blk_n;
    sc_signal< sc_lv<4> > p_0105_0_reg_64;
    sc_signal< sc_lv<1> > icmp_ln899_fu_75_p2;
    ...
    void thread_icmp_ln899_fu_75_p2();
