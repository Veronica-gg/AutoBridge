...
#ifndef _kernel0_A_IO_L1_in_0_7_s_HH_
#define _kernel0_A_IO_L1_in_0_7_s_HH_
...
struct kernel0_A_IO_L1_in_0_7_s : public sc_module {
    ...
    // Module declarations
    kernel0_A_IO_L1_in_0_7_s(sc_module_name name);
    SC_HAS_PROCESS(kernel0_A_IO_L1_in_0_7_s);

    ~kernel0_A_IO_L1_in_0_7_s();

    sc_trace_file* mVcdFile;

    kernel0_kernel0_mux_205_32_1_1<1,1,32,32,32,32,32,32,32,32,32,32,32,32,32,32,32,32,32,32,32,32,5,32>* kernel0_mux_205_32_1_1_U39;
    ...
    sc_signal< sc_lv<1> > icmp_ln899_8_reg_621;
    ...
    sc_signal< sc_lv<1> > icmp_ln899_8_fu_244_p2;
    sc_signal< bool > ap_block_state3_pp0_stage0_iter0;
    sc_signal< bool > ap_block_state4_pp0_stage0_iter1;
    sc_signal< bool > ap_block_pp0_stage0_11001;
    sc_signal< sc_lv<5> > c2_V_5_fu_250_p2;
    sc_signal< sc_logic > ap_enable_reg_pp0_iter0;
    sc_signal< sc_lv<5> > c1_V_fu_256_p2;
    sc_signal< sc_logic > ap_CS_fsm_state5;
    sc_signal< sc_lv<1> > icmp_ln899_7_fu_262_p2;
    sc_signal< sc_lv<1> > icmp_ln899_7_reg_635;
    sc_signal< bool > ap_block_state6_pp1_stage0_iter0;
    sc_signal< bool > ap_block_state7_pp1_stage0_iter1;
    sc_signal< bool > ap_block_pp1_stage0_11001;
    sc_signal< sc_lv<5> > c2_V_6_fu_268_p2;
    sc_signal< sc_lv<5> > c2_V_6_reg_639;
    ...
    sc_signal< sc_lv<32> > tmp_2236_fu_88;
    sc_signal< sc_lv<32> > tmp_2237_fu_92;
    sc_signal< sc_lv<32> > tmp_2238_fu_96;
    sc_signal< sc_lv<32> > tmp_2239_fu_100;
    sc_signal< sc_lv<32> > tmp_2240_fu_104;
    sc_signal< sc_lv<32> > tmp_2241_fu_108;
    sc_signal< sc_lv<32> > tmp_2242_fu_112;
    sc_signal< sc_lv<32> > tmp_2243_fu_116;
    sc_signal< sc_lv<32> > tmp_2244_fu_120;
    sc_signal< sc_lv<32> > tmp_2245_fu_124;
    sc_signal< sc_lv<32> > tmp_2246_fu_128;
    sc_signal< sc_lv<32> > tmp_2247_fu_132;
    sc_signal< sc_lv<32> > tmp_2248_fu_136;
    sc_signal< sc_lv<32> > tmp_2249_fu_140;
    sc_signal< sc_lv<32> > tmp_2250_fu_144;
    sc_signal< sc_lv<32> > tmp_2251_fu_148;
    sc_signal< sc_lv<32> > tmp_2252_fu_152;
    sc_signal< sc_lv<32> > tmp_2253_fu_156;
    sc_signal< sc_lv<32> > tmp_2254_fu_160;
    ...
    void thread_c2_V_5_fu_250_p2();
    void thread_c2_V_6_fu_268_p2();
    ...
    void thread_icmp_ln899_7_fu_262_p2();
    void thread_icmp_ln899_8_fu_244_p2();
