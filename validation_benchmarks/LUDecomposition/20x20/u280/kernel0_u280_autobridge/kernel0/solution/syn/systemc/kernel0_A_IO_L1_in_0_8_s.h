...
#ifndef _kernel0_A_IO_L1_in_0_8_s_HH_
#define _kernel0_A_IO_L1_in_0_8_s_HH_
...
struct kernel0_A_IO_L1_in_0_8_s : public sc_module {
    ...
    // Module declarations
    kernel0_A_IO_L1_in_0_8_s(sc_module_name name);
    SC_HAS_PROCESS(kernel0_A_IO_L1_in_0_8_s);

    ~kernel0_A_IO_L1_in_0_8_s();

    sc_trace_file* mVcdFile;

    kernel0_kernel0_mux_205_32_1_1<1,1,32,32,32,32,32,32,32,32,32,32,32,32,32,32,32,32,32,32,32,32,5,32>* kernel0_mux_205_32_1_1_U43;
    ...
    sc_signal< sc_lv<1> > icmp_ln899_6_reg_621;
    ...
    sc_signal< sc_lv<1> > icmp_ln899_6_fu_244_p2;
    sc_signal< bool > ap_block_state3_pp0_stage0_iter0;
    sc_signal< bool > ap_block_state4_pp0_stage0_iter1;
    sc_signal< bool > ap_block_pp0_stage0_11001;
    sc_signal< sc_lv<5> > c2_V_3_fu_250_p2;
    sc_signal< sc_logic > ap_enable_reg_pp0_iter0;
    sc_signal< sc_lv<5> > c1_V_fu_256_p2;
    sc_signal< sc_logic > ap_CS_fsm_state5;
    sc_signal< sc_lv<1> > icmp_ln899_5_fu_262_p2;
    sc_signal< sc_lv<1> > icmp_ln899_5_reg_635;
    sc_signal< bool > ap_block_state6_pp1_stage0_iter0;
    sc_signal< bool > ap_block_state7_pp1_stage0_iter1;
    sc_signal< bool > ap_block_pp1_stage0_11001;
    sc_signal< sc_lv<5> > c2_V_4_fu_268_p2;
    sc_signal< sc_lv<5> > c2_V_4_reg_639;
    ...
    sc_signal< sc_lv<32> > tmp_2212_fu_88;
    sc_signal< sc_lv<32> > tmp_2213_fu_92;
    sc_signal< sc_lv<32> > tmp_2214_fu_96;
    sc_signal< sc_lv<32> > tmp_2215_fu_100;
    sc_signal< sc_lv<32> > tmp_2216_fu_104;
    sc_signal< sc_lv<32> > tmp_2217_fu_108;
    sc_signal< sc_lv<32> > tmp_2218_fu_112;
    sc_signal< sc_lv<32> > tmp_2219_fu_116;
    sc_signal< sc_lv<32> > tmp_2220_fu_120;
    sc_signal< sc_lv<32> > tmp_2221_fu_124;
    sc_signal< sc_lv<32> > tmp_2222_fu_128;
    sc_signal< sc_lv<32> > tmp_2223_fu_132;
    sc_signal< sc_lv<32> > tmp_2224_fu_136;
    sc_signal< sc_lv<32> > tmp_2225_fu_140;
    sc_signal< sc_lv<32> > tmp_2226_fu_144;
    sc_signal< sc_lv<32> > tmp_2227_fu_148;
    sc_signal< sc_lv<32> > tmp_2228_fu_152;
    sc_signal< sc_lv<32> > tmp_2229_fu_156;
    sc_signal< sc_lv<32> > tmp_2230_fu_160;
    ...
    void thread_c2_V_3_fu_250_p2();
    void thread_c2_V_4_fu_268_p2();
    ...
    void thread_icmp_ln899_5_fu_262_p2();
    void thread_icmp_ln899_6_fu_244_p2();
