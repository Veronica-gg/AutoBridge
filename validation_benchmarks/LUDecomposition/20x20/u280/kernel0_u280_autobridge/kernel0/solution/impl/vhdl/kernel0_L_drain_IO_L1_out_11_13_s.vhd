...
entity kernel0_L_drain_IO_L1_out_11_13_s is
port (
    ap_clk : IN STD_LOGIC;
    ap_rst : IN STD_LOGIC;
...
architecture behav of kernel0_L_drain_IO_L1_out_11_13_s is 
...
begin
    ...
    icmp_ln879_fu_79_p2 <= "1" when (p_0_0_i_reg_62 = ap_const_lv5_D) else "0";
end behav;
