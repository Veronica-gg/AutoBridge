set moduleName PE_wrapper_0_0_s
set isTopModule 0
...
set C_modelName {PE_wrapper<0, 0>}
...
set portList { 
	...
	{ fifo_U_tmp_1_out_V_din sc_out sc_lv 32 signal 0 } 
	{ fifo_U_tmp_1_out_V_full_n sc_in sc_logic 1 signal 0 } 
	{ fifo_U_tmp_1_out_V_write sc_out sc_logic 1 signal 0 } 
	{ fifo_A_in_V_dout sc_in sc_lv 32 signal 1 } 
	{ fifo_A_in_V_empty_n sc_in sc_logic 1 signal 1 } 
	{ fifo_A_in_V_read sc_out sc_logic 1 signal 1 } 
...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1"],
		...
		"WaitState" : [
			{"State" : "ap_ST_fsm_state2", "FSM" : "ap_CS_fsm", "SubInstance" : "grp_PE_0_0_s_fu_20"}],
		"Port" : [
			{"Name" : "fifo_U_tmp_1_out_V", "Type" : "Fifo", "Direction" : "O", "DependentProc" : "0", "DependentChan" : "0",
				"SubConnect" : [
					{"ID" : "1", "SubInstance" : "grp_PE_0_0_s_fu_20", "Port" : "fifo_U_tmp_1_out_V"}]},
			{"Name" : "fifo_A_in_V", "Type" : "Fifo", "Direction" : "I", "DependentProc" : "0", "DependentChan" : "0",
				"SubConnect" : [
					{"ID" : "1", "SubInstance" : "grp_PE_0_0_s_fu_20", "Port" : "fifo_A_in_V"}]},
			{"Name" : "fifo_U_drain_out_V", "Type" : "Fifo", "Direction" : "O", "DependentProc" : "0", "DependentChan" : "0",
				"SubConnect" : [
					{"ID" : "1", "SubInstance" : "grp_PE_0_0_s_fu_20", "Port" : "fifo_U_drain_out_V"}]}]},
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.grp_PE_0_0_s_fu_20", "Parent" : "0",
		"CDFG" : "PE_0_0_s",
		"Protocol" : "ap_ctrl_hs",
