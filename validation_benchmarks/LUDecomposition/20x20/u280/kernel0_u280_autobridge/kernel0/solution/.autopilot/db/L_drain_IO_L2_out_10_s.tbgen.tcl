set moduleName L_drain_IO_L2_out_10_s
set isTopModule 0
...
set C_modelName {L_drain_IO_L2_out<10>}
set C_modelType { void 0 }
set C_modelArgList {
	{ fifo_L_drain_in_V float 32 regular {fifo 0 volatile }  }
	{ fifo_L_drain_out_V float 32 regular {fifo 1 volatile }  }
	{ fifo_L_drain_local_in_V float 32 regular {fifo 0 volatile }  }
}
set C_modelArgMapList {[ 
	{ "Name" : "fifo_L_drain_in_V", "interface" : "fifo", "bitwidth" : 32, "direction" : "READONLY"} , 
...
set portList { 
	...
	{ fifo_L_drain_in_V_dout sc_in sc_lv 32 signal 0 } 
	{ fifo_L_drain_in_V_empty_n sc_in sc_logic 1 signal 0 } 
	{ fifo_L_drain_in_V_read sc_out sc_logic 1 signal 0 } 
	{ fifo_L_drain_out_V_din sc_out sc_lv 32 signal 1 } 
	{ fifo_L_drain_out_V_full_n sc_in sc_logic 1 signal 1 } 
	{ fifo_L_drain_out_V_write sc_out sc_logic 1 signal 1 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "fifo_L_drain_in_V_dout", "direction": "in", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "fifo_L_drain_in_V", "role": "dout" }} , 
 	{ "name": "fifo_L_drain_in_V_empty_n", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "fifo_L_drain_in_V", "role": "empty_n" }} , 
 	{ "name": "fifo_L_drain_in_V_read", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "fifo_L_drain_in_V", "role": "read" }} , 
...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "",
		...
		"Port" : [
			{"Name" : "fifo_L_drain_in_V", "Type" : "Fifo", "Direction" : "I", "DependentProc" : "0", "DependentChan" : "0",
				"BlockSignal" : [
					{"Name" : "fifo_L_drain_in_V_blk_n", "Type" : "RtlSignal"}]},
...
set ArgLastReadFirstWriteLatency {
	L_drain_IO_L2_out_10_s {
		fifo_L_drain_in_V {Type I LastRead 3 FirstWrite -1}
		fifo_L_drain_out_V {Type O LastRead -1 FirstWrite 3}
...
set Spec2ImplPortList { 
	fifo_L_drain_in_V { ap_fifo {  { fifo_L_drain_in_V_dout fifo_data 0 32 }  { fifo_L_drain_in_V_empty_n fifo_status 0 1 }  { fifo_L_drain_in_V_read fifo_update 1 1 } } }
