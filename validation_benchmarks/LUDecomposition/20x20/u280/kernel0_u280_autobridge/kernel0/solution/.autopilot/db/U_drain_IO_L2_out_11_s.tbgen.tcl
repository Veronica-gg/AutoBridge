set moduleName U_drain_IO_L2_out_11_s
set isTopModule 0
...
set C_modelName {U_drain_IO_L2_out<11>}
set C_modelType { void 0 }
set C_modelArgList {
	{ fifo_U_drain_in_V float 32 regular {fifo 0 volatile }  }
	{ fifo_U_drain_out_V float 32 regular {fifo 1 volatile }  }
	{ fifo_U_drain_local_in_V float 32 regular {fifo 0 volatile }  }
}
set C_modelArgMapList {[ 
	{ "Name" : "fifo_U_drain_in_V", "interface" : "fifo", "bitwidth" : 32, "direction" : "READONLY"} , 
...
set portList { 
	...
	{ fifo_U_drain_in_V_dout sc_in sc_lv 32 signal 0 } 
	{ fifo_U_drain_in_V_empty_n sc_in sc_logic 1 signal 0 } 
	{ fifo_U_drain_in_V_read sc_out sc_logic 1 signal 0 } 
	{ fifo_U_drain_out_V_din sc_out sc_lv 32 signal 1 } 
	{ fifo_U_drain_out_V_full_n sc_in sc_logic 1 signal 1 } 
	{ fifo_U_drain_out_V_write sc_out sc_logic 1 signal 1 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "fifo_U_drain_in_V_dout", "direction": "in", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "fifo_U_drain_in_V", "role": "dout" }} , 
 	{ "name": "fifo_U_drain_in_V_empty_n", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "fifo_U_drain_in_V", "role": "empty_n" }} , 
 	{ "name": "fifo_U_drain_in_V_read", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "fifo_U_drain_in_V", "role": "read" }} , 
...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "",
		"CDFG" : "U_drain_IO_L2_out_11_s",
		"Protocol" : "ap_ctrl_hs",
		"ControlExist" : "1", "ap_start" : "1", "ap_ready" : "1", "ap_done" : "1", "ap_continue" : "1", "ap_idle" : "1",
		"Pipeline" : "None", "UnalignedPipeline" : "0", "RewindPipeline" : "0", "ProcessNetwork" : "0",
		"II" : "0",
		"VariableLatency" : "1", "ExactLatency" : "-1", "EstimateLatencyMin" : "37", "EstimateLatencyMax" : "109",
		"Combinational" : "0",
		"Datapath" : "0",
		"ClockEnable" : "0",
		"HasSubDataflow" : "0",
		...
		"Port" : [
			{"Name" : "fifo_U_drain_in_V", "Type" : "Fifo", "Direction" : "I", "DependentProc" : "0", "DependentChan" : "0",
				"BlockSignal" : [
					{"Name" : "fifo_U_drain_in_V_blk_n", "Type" : "RtlSignal"}]},
...
set ArgLastReadFirstWriteLatency {
	U_drain_IO_L2_out_11_s {
		fifo_U_drain_in_V {Type I LastRead 3 FirstWrite -1}
		fifo_U_drain_out_V {Type O LastRead -1 FirstWrite 3}
		fifo_U_drain_local_in_V {Type I LastRead 3 FirstWrite -1}}}

set hasDtUnsupportedChannel 0

set PerformanceInfo {[
	{"Name" : "Latency", "Min" : "37", "Max" : "109"}
	, {"Name" : "Interval", "Min" : "37", "Max" : "109"}
]}
...
set Spec2ImplPortList { 
	fifo_U_drain_in_V { ap_fifo {  { fifo_U_drain_in_V_dout fifo_data 0 32 }  { fifo_U_drain_in_V_empty_n fifo_status 0 1 }  { fifo_U_drain_in_V_read fifo_update 1 1 } } }
