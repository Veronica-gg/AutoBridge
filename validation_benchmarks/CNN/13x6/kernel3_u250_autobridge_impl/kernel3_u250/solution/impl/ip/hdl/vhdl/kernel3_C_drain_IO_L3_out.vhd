...
architecture behav of kernel3_C_drain_IO_L3_out is 
    ...
    signal zext_ln1789_fu_117_p1 : STD_LOGIC_VECTOR (63 downto 0);
...
begin
    ...
    icmp_ln887_fu_127_p2 <= "1" when (ap_phi_mux_t_V_phi_fu_100_p4 = ap_const_lv13_1380) else "0";
    ...
    m_axi_C_V_AWADDR <= zext_ln1789_fu_117_p1;
    ...
    zext_ln1789_fu_117_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(C_V_offset1_i_reg_152),64));
end behav;
