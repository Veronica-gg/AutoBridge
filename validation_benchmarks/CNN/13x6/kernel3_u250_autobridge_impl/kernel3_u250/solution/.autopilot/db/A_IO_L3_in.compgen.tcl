...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { A_V_offset_dout { I 64 vector } A_V_offset_empty_n { I 1 bit } A_V_offset_read { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { fifo_A_local_out_V_V_din { O 256 vector } fifo_A_local_out_V_V_full_n { I 1 bit } fifo_A_local_out_V_V_write { O 1 bit } } \
} "
}
