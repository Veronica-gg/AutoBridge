...
set C_modelArgList {
	{ idx int 5 regular  }
	{ local_A_V int 256 regular {array 1024 { 3 0 } 0 1 }  }
...
set C_modelArgMapList {[ 
	{ "Name" : "idx", "interface" : "wire", "bitwidth" : 5, "direction" : "READONLY"} , 
 	{ "Name" : "local_A_V", "interface" : "memory", "bitwidth" : 256, "direction" : "WRITEONLY"} , 
...
set portList { 
	...
	{ local_A_V_address1 sc_out sc_lv 10 signal 1 } 
	{ local_A_V_ce1 sc_out sc_logic 1 signal 1 } 
	{ local_A_V_we1 sc_out sc_logic 1 signal 1 } 
	{ local_A_V_d1 sc_out sc_lv 256 signal 1 } 
	{ fifo_A_in_V_V_dout sc_in sc_lv 256 signal 2 } 
	{ fifo_A_in_V_V_empty_n sc_in sc_logic 1 signal 2 } 
	{ fifo_A_in_V_V_read sc_out sc_logic 1 signal 2 } 
	{ fifo_A_out_V_V_din sc_out sc_lv 256 signal 3 } 
	{ fifo_A_out_V_V_full_n sc_in sc_logic 1 signal 3 } 
	{ fifo_A_out_V_V_write sc_out sc_logic 1 signal 3 } 
}
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "local_A_V_address1", "direction": "out", "datatype": "sc_lv", "bitwidth":10, "type": "signal", "bundle":{"name": "local_A_V", "role": "address1" }} , 
 	...
 	{ "name": "local_A_V_d1", "direction": "out", "datatype": "sc_lv", "bitwidth":256, "type": "signal", "bundle":{"name": "local_A_V", "role": "d1" }} , 
...
set PerformanceInfo {[
	{"Name" : "Latency", "Min" : "2", "Max" : "8193"}
	, {"Name" : "Interval", "Min" : "2", "Max" : "8193"}
]}
...
set Spec2ImplPortList { 
	...
	local_A_V { ap_memory {  { local_A_V_address1 MemPortADDR2 1 10 }  { local_A_V_ce1 MemPortCE2 1 1 }  { local_A_V_we1 MemPortWE2 1 1 }  { local_A_V_d1 MemPortDIN2 1 256 } } }
