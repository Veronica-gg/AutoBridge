...
set IPName      "kernel3"
set Version     "1.0"
set DisplayName "Kernel3"
set Revision    "2106101158"
...
set sdx_kernel_name "kernel3"
set sdx_kernel_type "hls"
set sdx_kernel_files {/home/users/veronica.grosso/AutoBridge/benchmarks/CNN/13x10/kernel3_u250_autobridge_impl/src/kernel_kernel_new.cpp}
set enable_xo_gen 1
set sdaccel_dir [file join [pwd] .. kernel]
set solution_dir "/home/users/veronica.grosso/AutoBridge/benchmarks/CNN/13x10/kernel3_u250_autobridge_impl/kernel3_u250/solution"
set debug_dir [file join $solution_dir .debug]
set xo_hls_files_dir "/home/users/veronica.grosso/AutoBridge/benchmarks/CNN/13x10/kernel3_u250_autobridge_impl/kernel3_u250/solution/impl/ip/hls_files"
set hdl_module_list {kernel3_A_IO_L2_in624_local_A
kernel3_B_IO_L2_in636_local_B
kernel3_kernel3_fadd_32ns_32ns_32_7_full_dsp_1
kernel3_kernel3_fmul_32ns_32ns_32_4_max_dsp_1
kernel3_PE_local_C
...
kernel3_fifo_w64_d2_A
kernel3_fifo_w64_d2_A
kernel3_kernel3_control_s_axi
kernel3_kernel3_gmem_A_m_axi
kernel3_kernel3_gmem_B_m_axi
kernel3_kernel3_gmem_C_m_axi
kernel3_entry14
A_IO_L3_in
...
set kernel_xo "/home/users/veronica.grosso/AutoBridge/benchmarks/CNN/13x10/kernel3_u250_autobridge_impl/polysa.xo"

## Variables
set Top "kernel3_kernel3"
set TopNoPrefix "kernel3"
...
set Interfaces {
    s_axi_control {
        ...
        registers {{0x00 CTRL       RW   0x0 "Control signals" {{ 0 1 AP_START RW 0 "Control signal Register for 'ap_start'." } { 1 1 AP_DONE R 0 "Control signal Register for 'ap_done'." } { 2 1 AP_IDLE R 0 "Control signal Register for 'ap_idle'." } { 3 1 AP_READY R 0 "Control signal Register for 'ap_ready'." } { 4 3 RESERVED_1 R 0 "Reserved.  0s on read." } { 7 1 AUTO_RESTART RW 0 "Control signal Register for 'auto_restart'." } { 8 24 RESERVED_2 R 0 "Reserved.  0s on read." }}} {0x04 GIER       RW   0x0 "Global Interrupt Enable Register" {{ 0 1 Enable RW 0 "Master enable for the device interrupt output to the system interrupt controller: 0 = Disabled, 1 = Enabled" } { 1 31 RESERVED R 0 "Reserved.  0s on read." }} } {0x08 IP_IER     RW   0x0 "IP Interrupt Enable Register" {{ 0 1 CHAN0_INT_EN RW 0 "Enable Channel 0 (ap_done) Interrupt.  0 = Disabled, 1 = Enabled." } { 1 1 CHAN1_INT_EN RW 0 "Enable Channel 1 (ap_ready) Interrupt.  0 = Disabled, 1 = Enabled." } { 2 30 RESERVED R 0 "Reserved.  0s on read." }}} {0x0c IP_ISR     RW   0x0 "IP Interrupt Status Register" {{ 0 1 CHAN0_INT_ST RTOW 0 "Channel 0 (ap_done) Interrupt Status. 0 = No Channel 0 input interrupt, 1 = Channel 0 input interrup" } { 1 1 CHAN1_INT_ST RTOW 0 "Channel 1 (ap_ready) Interrupt Status. 0 = No Channel 1 input interrupt, 1 = Channel 1 input interrup" } { 2 30 RESERVED R 0 "Reserved.  0s on read." }}} {0x10 A_V_1 W 0x0 "Data signal of A_V" {{0 32 A_V W 0 "Bit 31 to 0 Data signal of A_V"}}} {0x14 A_V_2 W 0x0 "Data signal of A_V" {{0 32 A_V W 0 "Bit 63 to 32 Data signal of A_V"}}} {0x1c B_V_1 W 0x0 "Data signal of B_V" {{0 32 B_V W 0 "Bit 31 to 0 Data signal of B_V"}}} {0x20 B_V_2 W 0x0 "Data signal of B_V" {{0 32 B_V W 0 "Bit 63 to 32 Data signal of B_V"}}} {0x28 C_V_1 W 0x0 "Data signal of C_V" {{0 32 C_V W 0 "Bit 31 to 0 Data signal of C_V"}}} {0x2c C_V_2 W 0x0 "Data signal of C_V" {{0 32 C_V W 0 "Bit 63 to 32 Data signal of C_V"}}}}
        memories ""
        ctype {
            AWVALID {
                Type "bool"
...
## System Info
set user_parameters_list {clk_period 3.333 machine 64 combinational 0 latency 66719 II x}
