...
architecture behav of kernel3_C_drain_IO_L3_out is 
    ...
    signal t_V_reg_96 : STD_LOGIC_VECTOR (13 downto 0);
    ...
    signal i_V_fu_133_p2 : STD_LOGIC_VECTOR (13 downto 0);
    signal i_V_reg_167 : STD_LOGIC_VECTOR (13 downto 0);
    ...
    signal ap_phi_mux_t_V_phi_fu_100_p4 : STD_LOGIC_VECTOR (13 downto 0);
    signal zext_ln2413_fu_117_p1 : STD_LOGIC_VECTOR (63 downto 0);
...
begin
    ...
    i_V_fu_133_p2 <= std_logic_vector(unsigned(ap_phi_mux_t_V_phi_fu_100_p4) + unsigned(ap_const_lv14_1));
    icmp_ln887_fu_127_p2 <= "1" when (ap_phi_mux_t_V_phi_fu_100_p4 = ap_const_lv14_2080) else "0";
    ...
    m_axi_C_V_AWADDR <= zext_ln2413_fu_117_p1;
    ...
    zext_ln2413_fu_117_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(C_V_offset1_i_reg_152),64));
end behav;
