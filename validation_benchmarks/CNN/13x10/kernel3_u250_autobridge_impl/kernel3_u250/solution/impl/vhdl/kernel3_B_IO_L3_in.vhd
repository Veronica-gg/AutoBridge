...
architecture behav of kernel3_B_IO_L3_in is 
    ...
    signal tmp_V_147_reg_175 : STD_LOGIC_VECTOR (255 downto 0);
...
begin
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((icmp_ln887_reg_161 = ap_const_lv1_0) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage1) and (ap_const_boolean_0 = ap_block_pp0_stage1_11001))) then
                tmp_V_147_reg_175 <= m_axi_B_V_RDATA(511 downto 256);
                tmp_V_reg_170 <= tmp_V_fu_136_p1;
            end if;
        end if;
    end process;

    ap_NS_fsm_assign_proc : process (ap_start, ap_done_reg, ap_CS_fsm, ap_CS_fsm_state1, m_axi_B_V_ARREADY, B_V_offset_empty_n, ap_CS_fsm_state2, ap_CS_fsm_pp0_stage1, ap_enable_reg_pp0_iter0, ap_enable_reg_pp0_iter1, icmp_ln887_fu_124_p2, ap_block_pp0_stage0_subdone, ap_block_pp0_stage1_subdone)
    begin
        case ap_CS_fsm is
    ...
    B_V_blk_n_R_assign_proc : process(m_axi_B_V_RVALID, ap_CS_fsm_pp0_stage1, ap_enable_reg_pp0_iter0, ap_block_pp0_stage1, icmp_ln887_reg_161)
    begin
    ...
    ap_block_pp0_stage0_01001_assign_proc : process(fifo_B_local_out_V_V_full_n, icmp_ln887_reg_161, ap_enable_reg_pp0_iter1)
    begin
                ap_block_pp0_stage0_01001 <= ((icmp_ln887_reg_161 = ap_const_lv1_0) and (fifo_B_local_out_V_V_full_n = ap_const_logic_0) and (ap_enable_reg_pp0_iter1 = ap_const_logic_1));
    end process;


    ap_block_pp0_stage0_11001_assign_proc : process(fifo_B_local_out_V_V_full_n, icmp_ln887_reg_161, ap_enable_reg_pp0_iter1)
    begin
                ap_block_pp0_stage0_11001 <= ((icmp_ln887_reg_161 = ap_const_lv1_0) and (fifo_B_local_out_V_V_full_n = ap_const_logic_0) and (ap_enable_reg_pp0_iter1 = ap_const_logic_1));
    end process;


    ap_block_pp0_stage0_subdone_assign_proc : process(fifo_B_local_out_V_V_full_n, icmp_ln887_reg_161, ap_enable_reg_pp0_iter1)
    begin
                ap_block_pp0_stage0_subdone <= ((icmp_ln887_reg_161 = ap_const_lv1_0) and (fifo_B_local_out_V_V_full_n = ap_const_logic_0) and (ap_enable_reg_pp0_iter1 = ap_const_logic_1));
    end process;

        ap_block_pp0_stage1 <= not((ap_const_boolean_1 = ap_const_boolean_1));

    ap_block_pp0_stage1_01001_assign_proc : process(m_axi_B_V_RVALID, fifo_B_local_out_V_V_full_n, ap_enable_reg_pp0_iter0, icmp_ln887_reg_161, ap_enable_reg_pp0_iter1, icmp_ln887_reg_161_pp0_iter1_reg)
    begin
                ap_block_pp0_stage1_01001 <= (((icmp_ln887_reg_161_pp0_iter1_reg = ap_const_lv1_0) and (fifo_B_local_out_V_V_full_n = ap_const_logic_0) and (ap_enable_reg_pp0_iter1 = ap_const_logic_1)) or ((icmp_ln887_reg_161 = ap_const_lv1_0) and (m_axi_B_V_RVALID = ap_const_logic_0) and (ap_enable_reg_pp0_iter0 = ap_const_logic_1)));
    end process;


    ap_block_pp0_stage1_11001_assign_proc : process(m_axi_B_V_RVALID, fifo_B_local_out_V_V_full_n, ap_enable_reg_pp0_iter0, icmp_ln887_reg_161, ap_enable_reg_pp0_iter1, icmp_ln887_reg_161_pp0_iter1_reg)
    begin
                ap_block_pp0_stage1_11001 <= (((icmp_ln887_reg_161_pp0_iter1_reg = ap_const_lv1_0) and (fifo_B_local_out_V_V_full_n = ap_const_logic_0) and (ap_enable_reg_pp0_iter1 = ap_const_logic_1)) or ((icmp_ln887_reg_161 = ap_const_lv1_0) and (m_axi_B_V_RVALID = ap_const_logic_0) and (ap_enable_reg_pp0_iter0 = ap_const_logic_1)));
    end process;


    ap_block_pp0_stage1_subdone_assign_proc : process(m_axi_B_V_RVALID, fifo_B_local_out_V_V_full_n, ap_enable_reg_pp0_iter0, icmp_ln887_reg_161, ap_enable_reg_pp0_iter1, icmp_ln887_reg_161_pp0_iter1_reg)
    begin
                ap_block_pp0_stage1_subdone <= (((icmp_ln887_reg_161_pp0_iter1_reg = ap_const_lv1_0) and (fifo_B_local_out_V_V_full_n = ap_const_logic_0) and (ap_enable_reg_pp0_iter1 = ap_const_logic_1)) or ((icmp_ln887_reg_161 = ap_const_lv1_0) and (m_axi_B_V_RVALID = ap_const_logic_0) and (ap_enable_reg_pp0_iter0 = ap_const_logic_1)));
    end process;
    ...
    ap_block_state10_pp0_stage1_iter0_assign_proc : process(m_axi_B_V_RVALID, icmp_ln887_reg_161)
    begin
                ap_block_state10_pp0_stage1_iter0 <= ((icmp_ln887_reg_161 = ap_const_lv1_0) and (m_axi_B_V_RVALID = ap_const_logic_0));
    end process;


    ap_block_state11_pp0_stage0_iter1_assign_proc : process(fifo_B_local_out_V_V_full_n, icmp_ln887_reg_161)
    begin
                ap_block_state11_pp0_stage0_iter1 <= ((icmp_ln887_reg_161 = ap_const_lv1_0) and (fifo_B_local_out_V_V_full_n = ap_const_logic_0));
    end process;


    ap_block_state12_pp0_stage1_iter1_assign_proc : process(fifo_B_local_out_V_V_full_n, icmp_ln887_reg_161_pp0_iter1_reg)
    begin
                ap_block_state12_pp0_stage1_iter1 <= ((icmp_ln887_reg_161_pp0_iter1_reg = ap_const_lv1_0) and (fifo_B_local_out_V_V_full_n = ap_const_logic_0));
    end process;
    ...
    fifo_B_local_out_V_V_blk_n_assign_proc : process(fifo_B_local_out_V_V_full_n, ap_CS_fsm_pp0_stage1, ap_block_pp0_stage1, icmp_ln887_reg_161, ap_CS_fsm_pp0_stage0, ap_enable_reg_pp0_iter1, ap_block_pp0_stage0, icmp_ln887_reg_161_pp0_iter1_reg)
    begin
    ...
    fifo_B_local_out_V_V_din_assign_proc : process(ap_enable_reg_pp0_iter1, tmp_V_reg_170, tmp_V_147_reg_175, ap_condition_325, ap_condition_329)
    begin
        if ((ap_enable_reg_pp0_iter1 = ap_const_logic_1)) then
            if ((ap_const_boolean_1 = ap_condition_329)) then 
                fifo_B_local_out_V_V_din <= tmp_V_147_reg_175;
    ...
    fifo_B_local_out_V_V_write_assign_proc : process(ap_CS_fsm_pp0_stage1, icmp_ln887_reg_161, ap_CS_fsm_pp0_stage0, ap_enable_reg_pp0_iter1, icmp_ln887_reg_161_pp0_iter1_reg, ap_block_pp0_stage0_11001, ap_block_pp0_stage1_11001)
    begin
    ...
    icmp_ln887_fu_124_p2 <= "1" when (ap_phi_mux_t_V_phi_fu_97_p4 = ap_const_lv14_2800) else "0";
    ...
    m_axi_B_V_RREADY_assign_proc : process(ap_CS_fsm_pp0_stage1, ap_enable_reg_pp0_iter0, icmp_ln887_reg_161, ap_block_pp0_stage1_11001)
    begin
