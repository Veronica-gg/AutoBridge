...
entity kernel3_C_drain_IO_L1_out_boundary744 is
port (
    ap_clk : IN STD_LOGIC;
    ap_rst : IN STD_LOGIC;
...
architecture behav of kernel3_C_drain_IO_L1_out_boundary744 is 
...
begin
    ...
    add_ln321_fu_369_p2 <= std_logic_vector(unsigned(zext_ln321_5_fu_366_p1) + unsigned(zext_ln2286_fu_362_p1));
    ...
    ap_phi_mux_p_0122_0_i_phi_fu_146_p4_assign_proc : process(ap_CS_fsm_pp0_stage0, ap_enable_reg_pp0_iter1, ap_block_pp0_stage0, icmp_ln2222_reg_380, p_0122_0_i_reg_142, select_ln1371_3_reg_389)
    begin
    ...
    ap_phi_mux_p_055_0_i_0_phi_fu_179_p4_assign_proc : process(ap_block_pp1_stage0, icmp_ln2284_reg_421, p_055_0_i_0_reg_175, ap_CS_fsm_pp1_stage0, select_ln544_6_reg_435, ap_enable_reg_pp1_iter1)
    begin
    ...
    zext_ln2286_fu_362_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(tmp_17_fu_355_p3),11));
