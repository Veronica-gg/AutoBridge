...
set C_modelArgList {
	{ B_V int 512 regular {axi_master 0}  }
	{ B_V_offset int 64 regular {fifo 0}  }
	{ fifo_B_local_out_V_V int 256 regular {fifo 1 volatile }  }
}
set C_modelArgMapList {[ 
	{ "Name" : "B_V", "interface" : "axi_master", "bitwidth" : 512, "direction" : "READONLY"} , 
 	{ "Name" : "B_V_offset", "interface" : "fifo", "bitwidth" : 64, "direction" : "READONLY"} , 
...
set portList { 
	...
	{ m_axi_B_V_AWADDR sc_out sc_lv 64 signal 0 } 
	...
	{ m_axi_B_V_WDATA sc_out sc_lv 512 signal 0 } 
	{ m_axi_B_V_WSTRB sc_out sc_lv 64 signal 0 } 
	...
	{ m_axi_B_V_ARADDR sc_out sc_lv 64 signal 0 } 
	...
	{ m_axi_B_V_RDATA sc_in sc_lv 512 signal 0 } 
	...
	{ B_V_offset_dout sc_in sc_lv 64 signal 1 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "m_axi_B_V_AWADDR", "direction": "out", "datatype": "sc_lv", "bitwidth":64, "type": "signal", "bundle":{"name": "B_V", "role": "AWADDR" }} , 
 	...
 	{ "name": "m_axi_B_V_WDATA", "direction": "out", "datatype": "sc_lv", "bitwidth":512, "type": "signal", "bundle":{"name": "B_V", "role": "WDATA" }} , 
 	{ "name": "m_axi_B_V_WSTRB", "direction": "out", "datatype": "sc_lv", "bitwidth":64, "type": "signal", "bundle":{"name": "B_V", "role": "WSTRB" }} , 
 	...
 	{ "name": "m_axi_B_V_ARADDR", "direction": "out", "datatype": "sc_lv", "bitwidth":64, "type": "signal", "bundle":{"name": "B_V", "role": "ARADDR" }} , 
 	...
 	{ "name": "m_axi_B_V_RDATA", "direction": "in", "datatype": "sc_lv", "bitwidth":512, "type": "signal", "bundle":{"name": "B_V", "role": "RDATA" }} , 
 	...
 	{ "name": "B_V_offset_dout", "direction": "in", "datatype": "sc_lv", "bitwidth":64, "type": "signal", "bundle":{"name": "B_V_offset", "role": "dout" }} , 
...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "",
		...
		"II" : "0",
		"VariableLatency" : "1", "ExactLatency" : "-1", "EstimateLatencyMin" : "20490", "EstimateLatencyMax" : "20490",
		"Combinational" : "0",
		"Datapath" : "0",
		"ClockEnable" : "0",
		"HasSubDataflow" : "0",
...
set PerformanceInfo {[
	{"Name" : "Latency", "Min" : "20490", "Max" : "20490"}
	, {"Name" : "Interval", "Min" : "20490", "Max" : "20490"}
]}
...
set Spec2ImplPortList { 
	B_V { m_axi {  { m_axi_B_V_AWVALID VALID 1 1 }  { m_axi_B_V_AWREADY READY 0 1 }  { m_axi_B_V_AWADDR ADDR 1 64 }  { m_axi_B_V_AWID ID 1 1 }  { m_axi_B_V_AWLEN LEN 1 32 }  { m_axi_B_V_AWSIZE SIZE 1 3 }  { m_axi_B_V_AWBURST BURST 1 2 }  { m_axi_B_V_AWLOCK LOCK 1 2 }  { m_axi_B_V_AWCACHE CACHE 1 4 }  { m_axi_B_V_AWPROT PROT 1 3 }  { m_axi_B_V_AWQOS QOS 1 4 }  { m_axi_B_V_AWREGION REGION 1 4 }  { m_axi_B_V_AWUSER USER 1 1 }  { m_axi_B_V_WVALID VALID 1 1 }  { m_axi_B_V_WREADY READY 0 1 }  { m_axi_B_V_WDATA DATA 1 512 }  { m_axi_B_V_WSTRB STRB 1 64 }  { m_axi_B_V_WLAST LAST 1 1 }  { m_axi_B_V_WID ID 1 1 }  { m_axi_B_V_WUSER USER 1 1 }  { m_axi_B_V_ARVALID VALID 1 1 }  { m_axi_B_V_ARREADY READY 0 1 }  { m_axi_B_V_ARADDR ADDR 1 64 }  { m_axi_B_V_ARID ID 1 1 }  { m_axi_B_V_ARLEN LEN 1 32 }  { m_axi_B_V_ARSIZE SIZE 1 3 }  { m_axi_B_V_ARBURST BURST 1 2 }  { m_axi_B_V_ARLOCK LOCK 1 2 }  { m_axi_B_V_ARCACHE CACHE 1 4 }  { m_axi_B_V_ARPROT PROT 1 3 }  { m_axi_B_V_ARQOS QOS 1 4 }  { m_axi_B_V_ARREGION REGION 1 4 }  { m_axi_B_V_ARUSER USER 1 1 }  { m_axi_B_V_RVALID VALID 0 1 }  { m_axi_B_V_RREADY READY 1 1 }  { m_axi_B_V_RDATA DATA 0 512 }  { m_axi_B_V_RLAST LAST 0 1 }  { m_axi_B_V_RID ID 0 1 }  { m_axi_B_V_RUSER USER 0 1 }  { m_axi_B_V_RRESP RESP 0 2 }  { m_axi_B_V_BVALID VALID 0 1 }  { m_axi_B_V_BREADY READY 1 1 }  { m_axi_B_V_BRESP RESP 0 2 }  { m_axi_B_V_BID ID 0 1 }  { m_axi_B_V_BUSER USER 0 1 } } }
	B_V_offset { ap_fifo {  { B_V_offset_dout fifo_data 0 64 }  { B_V_offset_empty_n fifo_status 0 1 }  { B_V_offset_read fifo_update 1 1 } } }
