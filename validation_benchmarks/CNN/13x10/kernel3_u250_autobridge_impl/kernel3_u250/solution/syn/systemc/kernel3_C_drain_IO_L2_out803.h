...
#ifndef _kernel3_C_drain_IO_L2_out803_HH_
#define _kernel3_C_drain_IO_L2_out803_HH_
...
struct kernel3_C_drain_IO_L2_out803 : public sc_module {
    ...
    // Module declarations
    kernel3_C_drain_IO_L2_out803(sc_module_name name);
    SC_HAS_PROCESS(kernel3_C_drain_IO_L2_out803);

    ~kernel3_C_drain_IO_L2_out803();
    ...
    sc_signal< sc_lv<17> > indvar_flatten31_reg_71;
    ...
    sc_signal< sc_lv<17> > add_ln2361_fu_120_p2;
    ...
    static const sc_lv<17> ap_const_lv17_10400;
