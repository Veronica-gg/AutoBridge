...
entity kernel3_C_drain_IO_L1_out793 is
port (
    ap_clk : IN STD_LOGIC;
    ap_rst : IN STD_LOGIC;
...
architecture behav of kernel3_C_drain_IO_L1_out793 is 
...
begin
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_enable_reg_pp1_iter2 = ap_const_logic_1) and (ap_const_boolean_0 = ap_block_pp1_stage0_11001))) then
                if (((select_ln879_3_reg_559_pp1_iter1_reg = ap_const_lv1_0) and (icmp_ln2255_reg_550_pp1_iter1_reg = ap_const_lv1_0))) then 
                    ap_phi_reg_pp1_iter3_tmp_V_reg_236 <= fifo_C_drain_in_V_V_dout;
                elsif (((select_ln879_3_reg_559_pp1_iter1_reg = ap_const_lv1_1) and (icmp_ln2255_reg_550_pp1_iter1_reg = ap_const_lv1_0))) then 
    ...
    add_ln321_fu_498_p2 <= std_logic_vector(unsigned(zext_ln2257_fu_491_p1) + unsigned(zext_ln321_23_fu_495_p1));
    ...
    ap_phi_mux_p_0122_0_i_phi_fu_163_p4_assign_proc : process(ap_CS_fsm_pp0_stage0, ap_enable_reg_pp0_iter1, ap_block_pp0_stage0, icmp_ln2222_reg_509, p_0122_0_i_reg_159, select_ln1371_12_reg_518)
    begin
    ...
    ap_phi_mux_p_041_0_i_phi_fu_218_p4_assign_proc : process(ap_block_pp1_stage0, icmp_ln2255_reg_550, p_041_0_i_reg_214, ap_CS_fsm_pp1_stage0, select_ln544_15_reg_573, ap_enable_reg_pp1_iter1)
    begin
    ...
    ap_predicate_op82_read_state8_assign_proc : process(icmp_ln2255_reg_550_pp1_iter1_reg, select_ln879_3_reg_559_pp1_iter1_reg)
    begin
                ap_predicate_op82_read_state8 <= ((select_ln879_3_reg_559_pp1_iter1_reg = ap_const_lv1_0) and (icmp_ln2255_reg_550_pp1_iter1_reg = ap_const_lv1_0));
    end process;
    ...
    fifo_C_drain_in_V_V_blk_n_assign_proc : process(fifo_C_drain_in_V_V_empty_n, ap_enable_reg_pp1_iter2, ap_block_pp1_stage0, icmp_ln2255_reg_550_pp1_iter1_reg, select_ln879_3_reg_559_pp1_iter1_reg)
    begin
        if (((select_ln879_3_reg_559_pp1_iter1_reg = ap_const_lv1_0) and (icmp_ln2255_reg_550_pp1_iter1_reg = ap_const_lv1_0) and (ap_const_boolean_0 = ap_block_pp1_stage0) and (ap_enable_reg_pp1_iter2 = ap_const_logic_1))) then 
    ...
    icmp_ln2255_fu_358_p2 <= "1" when (indvar_flatten20_reg_181 = ap_const_lv13_1800) else "0";
