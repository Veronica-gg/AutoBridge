...
architecture behav of kernel3_A_IO_L3_in is 
    ...
    signal tmp_V_148_reg_175 : STD_LOGIC_VECTOR (255 downto 0);
...
begin
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((icmp_ln887_reg_161 = ap_const_lv1_0) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage1) and (ap_const_boolean_0 = ap_block_pp0_stage1_11001))) then
                tmp_V_148_reg_175 <= m_axi_A_V_RDATA(511 downto 256);
    ...
    fifo_A_local_out_V_V_din_assign_proc : process(ap_enable_reg_pp0_iter1, tmp_V_reg_170, tmp_V_148_reg_175, ap_condition_325, ap_condition_329)
    begin
        if ((ap_enable_reg_pp0_iter1 = ap_const_logic_1)) then
            if ((ap_const_boolean_1 = ap_condition_329)) then 
                fifo_A_local_out_V_V_din <= tmp_V_148_reg_175;
