...
#ifndef _kernel3_A_IO_L3_in_HH_
#define _kernel3_A_IO_L3_in_HH_
...
struct kernel3_A_IO_L3_in : public sc_module {
    ...
    sc_out< sc_lv<64> > m_axi_A_V_AWADDR;
    ...
    sc_out< sc_lv<64> > m_axi_A_V_ARADDR;
    ...
    sc_in< sc_lv<64> > A_V_offset_dout;
    ...
    // Module declarations
    kernel3_A_IO_L3_in(sc_module_name name);
    SC_HAS_PROCESS(kernel3_A_IO_L3_in);
    ...
    sc_signal< sc_lv<58> > A_V_offset1_i_reg_150;
    ...
    sc_signal< sc_lv<256> > tmp_V_120_reg_175;
    ...
    sc_signal< sc_lv<64> > zext_ln3_fu_114_p1;
    ...
    void thread_zext_ln3_fu_114_p1();
