...
entity kernel0_L_drain_IO_L1_out_5_10_s is
port (
    ap_clk : IN STD_LOGIC;
    ap_rst : IN STD_LOGIC;
...
architecture behav of kernel0_L_drain_IO_L1_out_5_10_s is 
    ...
    signal p_0_0_i_reg_62 : STD_LOGIC_VECTOR (3 downto 0);
    ...
    signal c1_V_fu_85_p2 : STD_LOGIC_VECTOR (3 downto 0);
...
begin
    ...
    c1_V_fu_85_p2 <= std_logic_vector(unsigned(p_0_0_i_reg_62) + unsigned(ap_const_lv4_1));
    ...
    icmp_ln399_fu_73_p2 <= "1" when (p_0_0_i_reg_62 = ap_const_lv4_C) else "0";
    icmp_ln879_fu_79_p2 <= "1" when (p_0_0_i_reg_62 = ap_const_lv4_A) else "0";
end behav;
