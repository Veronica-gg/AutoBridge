...
#ifndef _kernel0_PE_9_9_s_HH_
#define _kernel0_PE_9_9_s_HH_
...
struct kernel0_PE_9_9_s : public sc_module {
    ...
    // Module declarations
    kernel0_PE_9_9_s(sc_module_name name);
    SC_HAS_PROCESS(kernel0_PE_9_9_s);
