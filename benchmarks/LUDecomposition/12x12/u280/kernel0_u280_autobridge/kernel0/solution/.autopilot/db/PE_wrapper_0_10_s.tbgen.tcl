set moduleName PE_wrapper_0_10_s
set isTopModule 0
...
set C_modelName {PE_wrapper<0, 10>}
...
set C_modelArgList {
	...
	{ fifo_A_in_V float 32 regular {fifo 0 volatile }  }
...
set C_modelArgMapList {[ 
	{ "Name" : "fifo_V_out_V", "interface" : "fifo", "bitwidth" : 32, "direction" : "WRITEONLY"} , 
 	...
 	{ "Name" : "fifo_A_in_V", "interface" : "fifo", "bitwidth" : 32, "direction" : "READONLY"} , 
...
set portList { 
	...
	{ fifo_V_out_V_din sc_out sc_lv 32 signal 0 } 
	{ fifo_V_out_V_full_n sc_in sc_logic 1 signal 0 } 
	{ fifo_V_out_V_write sc_out sc_logic 1 signal 0 } 
	{ fifo_U_tmp_1_in_V_dout sc_in sc_lv 32 signal 1 } 
	{ fifo_U_tmp_1_in_V_empty_n sc_in sc_logic 1 signal 1 } 
	{ fifo_U_tmp_1_in_V_read sc_out sc_logic 1 signal 1 } 
	{ fifo_U_tmp_1_out_V_din sc_out sc_lv 32 signal 2 } 
	{ fifo_U_tmp_1_out_V_full_n sc_in sc_logic 1 signal 2 } 
	{ fifo_U_tmp_1_out_V_write sc_out sc_logic 1 signal 2 } 
	{ fifo_A_in_V_dout sc_in sc_lv 32 signal 3 } 
	{ fifo_A_in_V_empty_n sc_in sc_logic 1 signal 3 } 
	{ fifo_A_in_V_read sc_out sc_logic 1 signal 3 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "fifo_A_in_V_dout", "direction": "in", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "fifo_A_in_V", "role": "dout" }} , 
 	{ "name": "fifo_A_in_V_empty_n", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "fifo_A_in_V", "role": "empty_n" }} , 
 	{ "name": "fifo_A_in_V_read", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "fifo_A_in_V", "role": "read" }} , 
...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1"],
		...
		"WaitState" : [
			{"State" : "ap_ST_fsm_state2", "FSM" : "ap_CS_fsm", "SubInstance" : "grp_PE_0_10_s_fu_24"}],
		"Port" : [
			{"Name" : "fifo_V_out_V", "Type" : "Fifo", "Direction" : "O", "DependentProc" : "0", "DependentChan" : "0",
				"SubConnect" : [
					{"ID" : "1", "SubInstance" : "grp_PE_0_10_s_fu_24", "Port" : "fifo_V_out_V"}]},
			{"Name" : "fifo_U_tmp_1_in_V", "Type" : "Fifo", "Direction" : "I", "DependentProc" : "0", "DependentChan" : "0",
				"SubConnect" : [
					{"ID" : "1", "SubInstance" : "grp_PE_0_10_s_fu_24", "Port" : "fifo_U_tmp_1_in_V"}]},
			{"Name" : "fifo_U_tmp_1_out_V", "Type" : "Fifo", "Direction" : "O", "DependentProc" : "0", "DependentChan" : "0",
				"SubConnect" : [
					{"ID" : "1", "SubInstance" : "grp_PE_0_10_s_fu_24", "Port" : "fifo_U_tmp_1_out_V"}]},
			{"Name" : "fifo_A_in_V", "Type" : "Fifo", "Direction" : "I", "DependentProc" : "0", "DependentChan" : "0",
				"SubConnect" : [
					{"ID" : "1", "SubInstance" : "grp_PE_0_10_s_fu_24", "Port" : "fifo_A_in_V"}]},
			{"Name" : "fifo_L_drain_out_V", "Type" : "Fifo", "Direction" : "O", "DependentProc" : "0", "DependentChan" : "0",
				"SubConnect" : [
					{"ID" : "1", "SubInstance" : "grp_PE_0_10_s_fu_24", "Port" : "fifo_L_drain_out_V"}]}]},
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.grp_PE_0_10_s_fu_24", "Parent" : "0", "Child" : ["2", "3", "4", "5"],
		"CDFG" : "PE_0_10_s",
		"Protocol" : "ap_ctrl_hs",
		...
		"Port" : [
			...
			{"Name" : "fifo_A_in_V", "Type" : "Fifo", "Direction" : "I",
				"BlockSignal" : [
					{"Name" : "fifo_A_in_V_blk_n", "Type" : "RtlSignal"}]},
			{"Name" : "fifo_L_drain_out_V", "Type" : "Fifo", "Direction" : "O",
				"BlockSignal" : [
					{"Name" : "fifo_L_drain_out_V_blk_n", "Type" : "RtlSignal"}]}]},
	{"ID" : "2", "Level" : "2", "Path" : "`AUTOTB_DUT_INST.grp_PE_0_10_s_fu_24.kernel0_fsub_32ns_32ns_32_7_full_dsp_1_U193", "Parent" : "1"},
	{"ID" : "3", "Level" : "2", "Path" : "`AUTOTB_DUT_INST.grp_PE_0_10_s_fu_24.kernel0_fmul_32ns_32ns_32_4_max_dsp_1_U194", "Parent" : "1"},
	{"ID" : "4", "Level" : "2", "Path" : "`AUTOTB_DUT_INST.grp_PE_0_10_s_fu_24.kernel0_fdiv_32ns_32ns_32_12_1_U195", "Parent" : "1"},
	{"ID" : "5", "Level" : "2", "Path" : "`AUTOTB_DUT_INST.grp_PE_0_10_s_fu_24.kernel0_mux_124_32_1_1_U196", "Parent" : "1"}]}
...
set ArgLastReadFirstWriteLatency {
	PE_wrapper_0_10_s {
		...
		fifo_A_in_V {Type I LastRead 2 FirstWrite -1}
...
set Spec2ImplPortList { 
	...
	fifo_A_in_V { ap_fifo {  { fifo_A_in_V_dout fifo_data 0 32 }  { fifo_A_in_V_empty_n fifo_status 0 1 }  { fifo_A_in_V_read fifo_update 1 1 } } }
