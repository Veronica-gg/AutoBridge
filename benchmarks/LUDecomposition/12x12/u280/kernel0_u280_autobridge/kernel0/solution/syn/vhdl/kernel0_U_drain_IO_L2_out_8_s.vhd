...
architecture behav of kernel0_U_drain_IO_L2_out_8_s is 
    ...
    signal p_093_0_reg_77 : STD_LOGIC_VECTOR (3 downto 0);
...
begin
    ...
    c0_V_fu_144_p2 <= std_logic_vector(unsigned(p_093_0_reg_77) + unsigned(ap_const_lv4_1));
    ...
    icmp_ln702_fu_111_p2 <= "1" when (p_093_0_reg_77 = ap_const_lv4_C) else "0";
    icmp_ln707_fu_150_p2 <= "1" when (c3_0_reg_100 = ap_const_lv3_4) else "0";
    icmp_ln879_fu_121_p2 <= "1" when (p_093_0_reg_77 = ap_const_lv4_8) else "0";
