set moduleName C_drain_IO_L1_out256
set isTopModule 0
...
set portList { 
	...
	{ fifo_C_drain_in_V_V_dout sc_in sc_lv 64 signal 0 } 
	{ fifo_C_drain_in_V_V_empty_n sc_in sc_logic 1 signal 0 } 
	{ fifo_C_drain_in_V_V_read sc_out sc_logic 1 signal 0 } 
	{ fifo_C_drain_out_V_V_din sc_out sc_lv 64 signal 1 } 
	{ fifo_C_drain_out_V_V_full_n sc_in sc_logic 1 signal 1 } 
	{ fifo_C_drain_out_V_V_write sc_out sc_logic 1 signal 1 } 
	{ fifo_C_drain_local_in_V_dout sc_in sc_lv 32 signal 2 } 
	{ fifo_C_drain_local_in_V_empty_n sc_in sc_logic 1 signal 2 } 
	{ fifo_C_drain_local_in_V_read sc_out sc_logic 1 signal 2 } 
}
set NewPortList {[ 
...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1"],
		"CDFG" : "C_drain_IO_L1_out256",
		"Protocol" : "ap_ctrl_hs",
		"ControlExist" : "1", "ap_start" : "1", "ap_ready" : "1", "ap_done" : "1", "ap_continue" : "1", "ap_idle" : "1",
		"Pipeline" : "None", "UnalignedPipeline" : "0", "RewindPipeline" : "0", "ProcessNetwork" : "0",
		"II" : "0",
		"VariableLatency" : "1", "ExactLatency" : "-1", "EstimateLatencyMin" : "7175", "EstimateLatencyMax" : "7175",
		"Combinational" : "0",
		"Datapath" : "0",
		"ClockEnable" : "0",
		"HasSubDataflow" : "0",
		...
		"Port" : [
			{"Name" : "fifo_C_drain_in_V_V", "Type" : "Fifo", "Direction" : "I", "DependentProc" : "0", "DependentChan" : "0",
				"BlockSignal" : [
...
set ArgLastReadFirstWriteLatency {
	C_drain_IO_L1_out256 {
		fifo_C_drain_in_V_V {Type I LastRead 5 FirstWrite -1}
...
set PerformanceInfo {[
	{"Name" : "Latency", "Min" : "7175", "Max" : "7175"}
	, {"Name" : "Interval", "Min" : "7175", "Max" : "7175"}
]}
